    ...
    public static void calculateHiveMetadataDetail() {
        try {
            ...
            var hiveMetastoreConnection = DriverManager.getConnection(
                    "jdbc:mysql://192.168.235.130:3306/hive?useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
                    "root",
                    "123456"
            );
...
//                    "jdbc:mysql://192.168.235.130:3306/yuntai_government?useSSL=false",
                    "jdbc:mysql://192.168.235.130:3306/yuntai_government?useSSL=false&allowPublicKeyRetrieval=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
                    "root",
                    "123456"
            );
